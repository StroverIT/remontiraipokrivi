...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>временно Bulgaria - Политика за бисквитките</title>
      ...
      <section className="container mt-48 text-black">
        ...
        <section className="mt-10 mb-20">
          <p>
            ...
            имейл: временноbg@gmail.com, телефон: {process.env.NEXT_PUBLIC_NUMBER_SHOW} относно
          ...
          <p className="mt-4 ml-10">
            ...
            на временноbg@gmail.com. Ние ще отговорим на вашето искане в
          ...
          <p className="mt-4 ml-10">
            ...
            имейл до нашия служител по жалбите на временно, drujba 2, имейл:
            временноbg@gmail.com. Ние ще отговорим на вашите опасения в
            съответствие с приложимото законодателство.
          </p>
        </section>
      </section>
